...
RnUI는 Tailwind CSS v4를 사용합니다. Blazor 프로젝트에 Tailwind CSS를 설정하고, RnUI 패키지의 클래스명을 스캔하도록 구성해야 합니다.
...
`wwwroot/input.css` 파일을 생성하고, RnUI 라이브러리의 Razor 파일을 스캔 대상에 포함시킵니다:
...
> **NuGet 패키지 사용 시**: NuGet으로 설치한 경우, 라이브러리의 `.razor` 파일이 로컬에 없으므로 별도의 `@source` 설정 없이도 RnUI 컴포넌트의 기본 스타일(`.cn-*` 클래스)은 `shadcn.css`에 포함되어 있어 정상 동작합니다. 프로젝트 내 `.razor` 파일에서 사용하는 Tailwind utility 클래스만 스캔하면 됩니다.
...
`App.razor` 또는 `_Host.cshtml`에 Tailwind CSS 출력 파일도 함께 연결합니다:

```html
<!-- RnUI 컴포넌트 스타일 -->
<link rel="stylesheet" href="_content/Daeha.RnUI/css/shadcn.css" />
<!-- Tailwind utility 클래스 -->
<link rel="stylesheet" href="css/tailwindcss.css" />
```

#### 4-5. CSS 빌드

개발 시에는 watch 모드를, 배포 시에는 build를 실행합니다:

```bash
npm run watch:css   # 개발 시 (파일 변경 감지)
npm run build:css   # 배포 시 (1회 빌드)
```
...
> 각 컴포넌트의 라이브 데모와 상세 사용법은 [**Demo Site**](https://daeha76.github.io/RnUI/components)에서 확인할 수 있습니다.
...
| `RnLabel` | 폼 레이블 | [Live](https://daeha76.github.io/RnUI/components/label) |
...
| Component | Description | Demo |
|---|---|---|
| `RnCard` | Header, Title, Description, Content, Footer, Action 구성 | [Live](https://daeha76.github.io/RnUI/components/card) |
| `RnAlert` | 알림 메시지 (Default, Destructive) | [Live](https://daeha76.github.io/RnUI/components/alert) |
| `RnBadge` | 상태 뱃지 | [Live](https://daeha76.github.io/RnUI/components/badge) |
...
| `RnResizable` | 크기 조절 가능 패널 | [Live](https://daeha76.github.io/RnUI/components/resizable) |
...
| `RnDataTable` | 고급 데이터 테이블 (정렬, 필터, 페이지네이션, 선택, 행 확장) | [Live](https://daeha76.github.io/RnUI/components/data-table) |
| `RnAvatar` | 사용자 아바타 (그룹 지원) | [Live](https://daeha76.github.io/RnUI/components/avatar) |
| `RnProgress` | 진행률 표시 | [Live](https://daeha76.github.io/RnUI/components/progress) |
...
| `RnBreadcrumb` | 경로 탐색 | [Live](https://daeha76.github.io/RnUI/components/breadcrumb) |
...
| Component | Description | Demo |
|---|---|---|
| `RnDialog` | 모달 다이얼로그 | [Live](https://daeha76.github.io/RnUI/components/dialog) |
| `RnAlertDialog` | 확인 다이얼로그 | [Live](https://daeha76.github.io/RnUI/components/alert-dialog) |
...
| `RnDrawer` | 드로어 (모바일 하단 시트) | [Live](https://daeha76.github.io/RnUI/components/drawer) |
...
| `RnEmpty` | 빈 상태 표시 | [Live](https://daeha76.github.io/RnUI/components/empty) |
| `RnCarousel` | 캐러셀/슬라이더 | [Live](https://daeha76.github.io/RnUI/components/carousel) |
| `RnCommand` | 커맨드 팔레트 | [Live](https://daeha76.github.io/RnUI/components/command) |
